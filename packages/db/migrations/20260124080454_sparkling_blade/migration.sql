...
DROP INDEX IF EXISTS `invitation_organization_id_idx`;--> statement-breakpoint
DROP INDEX IF EXISTS `invitation_email_idx`;--> statement-breakpoint
DROP INDEX IF EXISTS `invitation_team_id_idx`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `invitation_organization_email_team_idx` ON `invitation` (`organization_id`,`email`,`team_id`);